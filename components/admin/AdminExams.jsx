...
const AdminExams = ({ userData, fetchUserData }) => {
  ...
  const getExams = async (next = true) => {
      ...
      {!loading && exams.length === 0 && (
        <div className="flex flex-col justify-center h-full">
          <EmptyState
            ...
            desc={
              "Looks like there are no exams yet. Once they are published, they will appear here."
            }
          />
        </div>
      )}

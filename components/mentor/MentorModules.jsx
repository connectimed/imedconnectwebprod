          ...
          {selectedPost && (
            <dialog id="module_modal" className="modal">
              <div className="modal-box">
                <p className="text-base-medium tracking-wide">
                  {selectedPost.module_title}
                </p>
                <Image
                  alt="image"
                ...
                />
                <p className="py-4 text-small-regular line-clamp-6 tracking-wide">
      ...
      {!loading && modules.length === 0 ? (
        <div className="flex flex-col justify-center h-full">
          <EmptyState
            ...
            desc={
              "Looks like you haven't published any module yet. Head to modules section to start publishing."
            }
          />
        </div>
      ) : (
        <NoticeList data={modules} />
      )}
    </div>
  );
};

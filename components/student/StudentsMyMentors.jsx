...
const StudentsMyMentors = ({ userData, fetchUserData }) => {
      ...
      {!loading && users.length === 0 && (
        <div className="flex flex-col justify-center h-full">
          <EmptyState
            ...
            desc={
              "Looks like there are no new students yet. Once new students sign up they will appear here."
            }
          />
        </div>
      )}
...
export default StudentsMyMentors;

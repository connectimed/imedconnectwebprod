const translations = {
  en: {
    ...
    // ── Verify Phone Number ──────────────────────────────────────────────────
    verify_heading: "Verify Phone Number!",
    verify_pre_send_body:
      "Secure your account with a quick verification. We'll send a one time code to your phone for added security. Click send code to send the code to +",
    verify_sent_body_prefix: "We have sent a one time code to +",
    verify_sent_body_suffix:
      ". Please fill in the code to continue. If you didn't receive the code you can send again in 60 seconds.",
    verify_resend_in: "Resend in",
    verify_seconds: "seconds",
    verify_click_resend: "Click to resend",
    verify_send_code_btn: "Send Code",
    verify_wrong_code: "Wrong code",

    // ── Account Decider ──────────────────────────────────────────────────────
    account_decider_heading: "Choose account!",
    account_decider_subtitle: "Please select your account type carefully.",
    account_decider_error: "Please select an account type",
    account_student_title: "Youth Graduate",
    account_student_desc:
      "Connect with experienced mentors and access diverse educational materials.",
    account_mentor_title: "Mentor",
    account_mentor_desc:
      "Join the community to share your knowledge and inspire the next generation.",
    account_entrepreneur_title: "Entrepreneur / MSME",
    account_entrepreneur_desc:
  ...
  sw: {
    ...
    // ── Verify Phone Number ──────────────────────────────────────────────────
    verify_heading: "Thibitisha Nambari ya Simu!",
    verify_pre_send_body:
      "Linda akaunti yako kwa uthibitisho wa haraka. Tutatuma nambari ya mara moja kwa simu yako kwa usalama zaidi. Bonyeza 'Tuma Nambari' kutuma nambari kwa +",
    verify_sent_body_prefix: "Tumekutumia nambari ya mara moja kwa +",
    verify_sent_body_suffix:
      ". Tafadhali jaza nambari kuendelea. Ikiwa hukupokea nambari unaweza kutuma tena baada ya sekunde 60.",
    verify_resend_in: "Tuma tena baada ya sekunde",
    verify_seconds: "",
    verify_click_resend: "Bonyeza kutuma tena",
    verify_send_code_btn: "Tuma Nambari",
    verify_wrong_code: "Nambari si sahihi",

    // ── Account Decider ──────────────────────────────────────────────────────
    account_decider_heading: "Chagua aina ya akaunti!",
    account_decider_subtitle: "Tafadhali chagua aina yako ya akaunti kwa makini.",
    account_decider_error: "Tafadhali chagua aina ya akaunti",
    account_student_title: "Mhitimu wa Vijana",
    account_student_desc:
      "Unganika na washauri wenye uzoefu na pata nyenzo mbalimbali za elimu.",
    account_mentor_title: "Mshauri",
    account_mentor_desc:
      "Jiunge na jamii kushiriki maarifa yako na kuwahamasisha kizazi kijacho.",
    account_entrepreneur_title: "Mjasiriamali / MSME",
    account_entrepreneur_desc:
      "Pata rasilimali na unganika na mitandao ya msaada kukuza biashara yako.",
